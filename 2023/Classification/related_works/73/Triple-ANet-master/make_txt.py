...
img_list_0 = np.concatenate(
    (img_list1_0, img_list2_0, img_list3_0, img_list4_0), axis=0)
labels = np.concatenate(
    (img_label1, img_label2, img_label3, img_label4), axis=0)
index = [i for i in range(
    len(img_list1)+len(img_list2)+len(img_list3)+len(img_list4))]
