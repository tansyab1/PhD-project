...
\subsection{Results}
\begin{frame}{Results}
    In this stage, we have to clean the existing distortion in the HyperKvasir dataset.\\ \pause
                      ...
                      \only<4>{
                          \node (tabnoise)  at (3.5,0){
                              \begin{adjustbox}{width=0.5\textwidth}
                                  ...
                                  \end{tabular}
                              \end{adjustbox}};
                          \node[text width=5cm] at (3.5, -2.0) {\small\textit{The variance Laplacian Index before and after deblurring.}};
