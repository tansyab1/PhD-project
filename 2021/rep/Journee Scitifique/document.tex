...
% \usebackgroundtemplate{\includegraphics{libs/Presentation1.pdf}
\begin{frame}{}
    \centering
...
\begin{frame}{Wireless Capsule Endoscopy}
    ...
    \alertbox{ \textbf{Colonoscopy} is often \textcolor{red}{unpleasant} and \textcolor{red}{uncomfortable} for the patient, can be \textcolor{red}{painful}, often requires moderate or deep sedation}

    \pause

    \successbox{\textbf{Wireless capsule endoscopy} is a minimally \example{non-invasive} technology and effects better analysis of proximal and distal parts of the intestine compares to the classical endoscopy.}
...
\begin{frame}{Objectives}
    ...
    There are \example{many types of distortions} $\&$ in \emph{different levels}
\end{frame}
...
\begin{frame}{Existing datasets}
    \begin{table}
        ...
        \begin{adjustbox}{width=\textwidth}
            \begin{tabular}{|l|l|l|}
                ...
                \textbf{Kvasir}  \cite{Pogorelov2017KVASIRAM}                              & \begin{tabular}[c]{@{}l@{}} Polyps, esophagitis, ulcerative colitis, Z-line,pylorus\\ cecum, dyed polyp, dyed resection margins, stool \end{tabular}                   & 8000 images                       \\ \hline
    ...
    \pause
    \tikz[remember picture]{ \node[anchor=base] (t3) {Using \emph{HyperKvasir}\footnote[frame]{\tiny Borgli, Hanna et al. “HyperKvasir, a comprehensive multi-class image and video dataset for gastrointestinal endoscopy.” \\Scientific Data 7 (2020)} \cite{Borgli2020HyperKvasirAC} dataset};}
    \begin{tikzpicture}[remember picture,overlay]   %% use here too
...
\begin{frame}{Ongoing work}
    \example{Our work} has three stages including:
    \begin{enumerate}
...
%                                       \hline
%                                                                    & \multicolumn{2}{c|}{\textbf{Original image}} & \multicolumn{2}{c|}{\textbf{Denoised-image}} \\ \hline
...
%                                   \end{tabular}
%                               \end{adjustbox}};
%                           \node[text width=5cm] at (4.0, -2.0) {\small{\textcolor{blue_theme}{Table 5:} The estimated noise standard deviation\footnote[frame]{Immerkær, John. “Fast Noise Variance Estimation.” Comput. Vis. \\Image Underst. 64 (1996): 300-302.} before and after denoising.}};
...
\begin{frame}{\small Results on Image denoising}
    \begin{figure}
        \includegraphics[width=0.6\textwidth]{libs/denoiseres.png}
...
\begin{frame}{\small Blurring index to estimate the level of blur}
    ...
    Apply the \example{variance of the Laplacian}\footnote[frame]{\tiny Pertuz, Said et al. “Analysis of focus measure operators for shape-from-focus.” Pattern Recognit. 46 (2013): 1415-1432.}\cite{Pertuz2013AnalysisOF} method to your own images to detect the amount of blurring.
    \begin{equation}
...
\begin{frame}{\small Results on image deblurring}
    \begin{figure}
        \includegraphics[width=0.6\textwidth]{libs/deblurres.png}
...
\begin{frame}{2. Generating artificial distortions and creating distorted image with controlled levels of distortions}
    % In this work, we create a model to add the artificial distortion to the image. There will be \example{four} different models corresponding to four kinds of distortions. We analysed the common level of distortion to simulate to realest artificial distortion which will make the dataset meaningful.
    \begin{itemize}
