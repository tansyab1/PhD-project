...
\begin{frame}{Ourwork}
    \begin{tikzpicture}
        ...
        \node[draw,fill=violet,text=white] (ArgumentB) at (5.3,-1) {Results};
...
\begin{frame}{Results}
    ...
    \begin{tikzpicture}[remember picture]
        ...
        \node(text) at (0,2) {\example{Stage 2:} We add the artificial distortion to the image};
        ...
        \only<1-3>{\item Specular Reflection\\
              \only<1-3>{
                  \begin{tikzpicture}[remember picture]
                      ...
                      \node (in)  at (-3,0){
                          \includegraphics[width=0.2\columnwidth]{libs/out2.png_inpainted.jpg} };
