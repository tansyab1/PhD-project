...
if __name__ == "__main__":
    ...
    frame = cv2.imread(
        '/content/drive/MyDrive/Colab Notebooks/PhD-project/Pre-processing/Isotropic/test.jpg')
    ...
    for max_intensity in max_intensities:
        for center in centers:
            ...
            hsv_res, mask, before, after = p.createUnevenIllumination(
                frame, center)
