...
parser.add_argument("--best_resnet", default="/work/vajira/DATA/hyper_kvasir/output/01_medico_2018_method_3_resnet152_split_1.py/checkpoints/01_medico_2018_method_3_resnet152_split_1.py_epoch:25.pt", help="Resnet best weight file")
parser.add_argument("--best_densenet", default="/work/vajira/DATA/hyper_kvasir/output/02_medico_2018_method_3_densenet161_split_1.py/checkpoints/02_medico_2018_method_3_densenet161_split_1.py_epoch:25.pt", help="Best densenet")
