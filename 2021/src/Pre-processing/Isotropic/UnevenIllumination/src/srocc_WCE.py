...
df_ihed = pd.read_csv(
    '/home/nguyentansy/Downloads/MOS.csv', delimiter=',', header= 0)
...
df_ihed.columns = ['Name', 'Level', 'PSNR', 'SSIM', 'MOS', 'MOSNON', 'IHED']
...
sorted_ihed = df_ihed.values[:, 6]
sorted_mosEx = df_ihed.values[:, 4]
sorted_mosNonEx = df_ihed.values[:, 5]
sorted_psnr = df_ihed.values[:, 2]
sorted_ssim = df_ihed.values[:, 3]
...
print("Spearan correlation coefficient between PSNR and MOS expert==>",
      stats.spearmanr(1/sorted_psnr, sorted_mosEx))

print("Spearan correlation coefficient between SSIM and MOS expert==>",
      stats.spearmanr(1/sorted_ssim, sorted_mosEx))
...
print("Spearmann correlation coefficient between PSNR and MOS non-expert==>",
      stats.spearmanr(1/sorted_psnr, sorted_mosNonEx))

print("Spearmann correlation coefficient between SSIM and MOS non-expert==>",
      stats.spearmanr(1/sorted_ssim, sorted_mosNonEx))
...
print("Pearson correlation coefficient between PSNR and MOS expert==>",
      stats.pearsonr(1/sorted_psnr, sorted_mosEx))

print("Pearson correlation coefficient between SSIM and MOS expert==>",
      stats.pearsonr(1/sorted_ssim, sorted_mosEx))
...
print("Pearson correlation coefficient between PSNR and MOS non-expert==>",
      stats.pearsonr(1/sorted_psnr, sorted_mosNonEx))

print("Pearson correlation coefficient between SSIM and MOS non-expert==>",
      stats.pearsonr(1/sorted_ssim, sorted_mosNonEx))
