...
Cite:
Mittal, Anish, Rajiv Soundararajan, and Alan C. Bovik. "Making a completely blind image quality astyzer." Signal Processing Letters, IEEE 20.3 (2013): 209-212.
"""
...
def niqe(img):
    model_mat = scipy.io.loadmat('/home/nguyentansy/DATA/PhD-work/PhD-project/2021/src/Pre-processing/Isotropic/UnevenIllumination/src/modelparameters.mat')
...
if __name__ == '__main__':
    ...
    img = cv2.imread('/home/nguyentansy/Downloads/bikes.bmp')
    # print(img.shape)
    # img = img[:,:,0]
