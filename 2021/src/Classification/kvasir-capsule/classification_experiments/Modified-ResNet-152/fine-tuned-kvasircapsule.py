...
parser.add_argument("--data_root", 
                default="~/dataport/ref",
                help="data root directory")


parser.add_argument("--data_to_inference", 
                default="~/dataport/interference/",
...
class MyNet(nn.Module):
    def __init__(self, num_out=14):
        ...
        # add new classifier containing conv layers
        # self.resnet_model.fc = nn.Sequential(
        #     nn.Conv2d(self.resnet_num_ftrs, 2048, kernel_size=1, stride=1, padding=0),
        #     nn.ReLU(),
        #     nn.Dropout(0.5),
        #     nn.Conv2d(2048, 2048, kernel_size=1, stride=1, padding=0),
        #     nn.ReLU(),
        #     nn.Dropout(0.5),
        #     nn.Conv2d(2048, num_out, kernel_size=1, stride=1, padding=0),
        # )
