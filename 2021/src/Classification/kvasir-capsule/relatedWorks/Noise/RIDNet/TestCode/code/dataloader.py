...
class _MSDataLoaderIter(_MultiProcessingDataLoaderIter):
    def __init__(self, loader):
        ...
        self._workers_status = [False] * self._num_workers
        ...
        if self._num_workers > 0:
            ...
            if self._pin_memory or self._timeout > 0:
                ...
                self._worker_manager_thread = threading.Thread(
                    target=_utils.pin_memory._pin_memory_loop,
                    args=(self._worker_result_queue, self._data_queue, maybe_device_id, self._workers_done_event))
                self._worker_manager_thread.daemon = True
                self._worker_manager_thread.start()
            else:
