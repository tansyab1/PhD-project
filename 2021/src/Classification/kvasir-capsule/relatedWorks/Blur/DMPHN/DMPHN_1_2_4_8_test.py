...
SAMPLE_DIR = "./datas/Blur_var/test/input/"
GT_DIR = "./datas/Blur_var/test/groundtruth/"
...
def main():
    ...
    # create folder to save test results if not exist
    if not os.path.exists('./test_results/' + EXPDIR):
