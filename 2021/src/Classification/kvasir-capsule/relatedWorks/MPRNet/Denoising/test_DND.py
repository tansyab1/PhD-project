...
parser = argparse.ArgumentParser(description='Image Denosiing using MPRNet')

parser.add_argument('--input_dir', default='./Datasets/Noise_var', type=str, help='Directory of validation images')
parser.add_argument('--result_dir', default='./results/', type=str, help='Directory for results')
parser.add_argument('--weights', default='./checkpoints/Denoising/models/MPRNet/model_best.pth', type=str, help='Path to weights')
