...
class ImageFolderWithPaths(datasets.ImageFolder):
    ...
    def create_triplet(self, index):
        ...
        return positive_index, negative_index, anchor_label
    ...
    def __getitem__(self, index):
        ...
        # create triplet of anchor, positive and negative images
        positive_index, negative_index, anchor_label = self.create_triplet(
            index)
        ...
        tuple_with_path = (
            original_tuple + (positive[0],) + (negative[0],) + (anchor_label,))
